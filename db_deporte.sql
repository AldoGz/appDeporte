...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-03-2018 a las 17:27:07
...
(14, '99999999', 'ANDY', 'SALINAS', 'DONAYRE', 1, '1991-02-11', 'defecto.jpg', 1);
...
CREATE TABLE `medidas` (
  ...
  `proyeccion_talla` decimal(6,2) DEFAULT NULL,
  `metabolismo` decimal(6,2) DEFAULT NULL,
  `factor_actividad` decimal(6,2) DEFAULT NULL,
  `total_calorias` decimal(6,2) DEFAULT NULL,
  `carbohidratos` decimal(6,2) DEFAULT NULL,
  `proteinas` decimal(6,2) DEFAULT NULL,
  `grasas` decimal(6,2) DEFAULT NULL,
  `pt_fecha_registro` date DEFAULT NULL,
  `codigo_factor` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
INSERT INTO `medidas` (`codigo_registro`, `codigo_alumno`, `tricipital`, `subescapular`, `supraespinal`, `abdominal`, `muslo_anterior`, `pierna_medial`, `muneica`, `femur`, `humero`, `bileocrestal`, `biacromial`, `mesoesternal`, `brazo`, `pierna`, `talla`, `talla_sentado`, `peso`, `por_adiposo`, `por_muscular`, `por_oseo`, `por_residual`, `peso_adiposo`, `peso_muscular`, `peso_oseo`, `peso_residual`, `endomorfia`, `mesomorfia`, `ectomorfia`, `valor_x`, `valor_y`, `imc`, `iem`, `iai`, `ictr`, `fecha_registro`, `estado`, `antropometricos`, `pliegues`, `diametros`, `perimetros`, `proyeccion_talla`, `metabolismo`, `factor_actividad`, `total_calorias`, `carbohidratos`, `proteinas`, `grasas`, `pt_fecha_registro`, `codigo_factor`) VALUES
(28, 14, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '120.00', '30.00', '29.00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2018-03-26 17:44:54', 1, 1, 0, 0, 0, NULL, '832.70', '1.70', '1415.59', '194.64', '53.08', '47.19', NULL, 2);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tabla_factor_actividad`
--

CREATE TABLE `tabla_factor_actividad` (
  `codigo_registro` int(11) NOT NULL,
  `descripcion` varchar(65) NOT NULL,
  `actividad_adulto_H` decimal(6,2) NOT NULL,
  `actividad_adolescente_H` decimal(6,2) NOT NULL,
  `actividad_adulto_M` decimal(6,2) NOT NULL,
  `actividad_adolescente_M` decimal(6,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `tabla_factor_actividad`
--

INSERT INTO `tabla_factor_actividad` (`codigo_registro`, `descripcion`, `actividad_adulto_H`, `actividad_adolescente_H`, `actividad_adulto_M`, `actividad_adolescente_M`) VALUES
(1, 'Actividad Ligera', '1.55', '1.58', '1.40', '1.65'),
(2, 'Actividad Moderada', '1.70', '1.58', '1.60', '1.65'),
(3, 'Actividad Intensa', '2.10', '2.30', '1.80', '1.80');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tabla_metabolismo_basal`
--

CREATE TABLE `tabla_metabolismo_basal` (
  `edad` int(11) NOT NULL,
  `percentil_H` decimal(6,2) NOT NULL,
  `percentil_M` decimal(6,2) NOT NULL,
  `acumulado_H` decimal(6,2) NOT NULL,
  `acumulado_M` decimal(6,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `tabla_metabolismo_basal`
--

INSERT INTO `tabla_metabolismo_basal` (`edad`, `percentil_H`, `percentil_M`, `acumulado_H`, `acumulado_M`) VALUES
(2, '60.90', '6.10', '54.00', '0.50'),
(10, '22.70', '22.50', '495.00', '499.00'),
(18, '17.50', '12.20', '651.00', '746.00'),
(30, '5.30', '14.70', '679.00', '496.00'),
(60, '11.60', '8.70', '879.00', '8.00'),
(120, '13.50', '10.50', '487.00', '5.00');
...
--
-- Indices de la tabla `tabla_factor_actividad`
--
ALTER TABLE `tabla_factor_actividad`
  ADD PRIMARY KEY (`codigo_registro`);

--
-- Indices de la tabla `tabla_metabolismo_basal`
--
ALTER TABLE `tabla_metabolismo_basal`
...
--
ALTER TABLE `alumnos`
  MODIFY `codigo_alumno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `inscripciones`
  MODIFY `codigo_inscripcion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT de la tabla `medidas`
--
ALTER TABLE `medidas`
  MODIFY `codigo_registro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
-- AUTO_INCREMENT de la tabla `tabla_factor_actividad`
--
ALTER TABLE `tabla_factor_actividad`
  MODIFY `codigo_registro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
