                    ...
                    <div class="card">
                        <div class="header">
                            <div class="row clearfix">
                                ...
                                <div class="col-xs-12 col-sm-2 align-right">
                                    <button id="btnAgregar" type="button" class="btn bg-cyan btn-block btn-sm waves-effect" data-toggle="modal" href="#myModal" title="Nuevo docente">NUEVO</button>
                                </div>
                            </div>
                        </div>
                        <div class="body">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form name="frm-grabar" id="frm-grabar"  role="form">
                                                    <div class="modal-body">
                                                        <input type="hidden" id="intCodigoDocente" name="intCodigoDocente" class="form-control">
                                                        ...
                                                        <div class="row clearfix">
                                                            <div class="col-sm-8">
                                                                ...
                                                                <div class="row clearfix">
                                                                    <div class="col-sm-8" id="idireccion">
                                                                        <div class="form-group form-float">
                                                                            <div class="form-line">
                                                                    ...
                                                                    <div class="col-sm-4" id="itelefono">
                                                                        <div class="form-group form-float">
                                                                            <div class="form-line">
                                                                                <input type="text" id="strTelefono" name="strTelefono" class="form-control" minlength="6" maxlength="9">
